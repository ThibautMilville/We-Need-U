...
const MissionsPage: React.FC = () => {
  ...
  const filteredMissions = useMemo(() => {
    let filtered = missions.filter(mission => {
      ...
      return matchesSearch && matchesCategory && matchesStatus && matchesType && matchesDifficulty;
    });
  ...
  const activeFiltersCount = [selectedCategory, selectedStatus, selectedType, selectedDifficulty].filter(Boolean).length;
  ...
  React.useEffect(() => {
    setCurrentPage(1);
  }, [searchTerm, selectedCategory, selectedStatus, selectedType, selectedDifficulty, sortBy]);
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-white to-blue-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        {/* Search and Controls */}
        <div className="mb-8 space-y-6 animate-fade-in-up" style={{animationDelay: '0.2s'}}>
          {/* Search bar */}
